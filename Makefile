...
gen-demo-proto:
	@cd demo/demo_proto && cwgo server -I ../../idl --type RPC --module github.com/kyzyc/biz-demo/demo/demo_proto --service demo_proto --idl ../../idl/echo.proto
...
gen-frontend:
	@cd app/frontend && cwgo server --type HTTP --idl ../../idl/frontend/auth_page.proto --service frontend -module github.com/kyzyc/biz-demo/app/frontend -I ../../idl

gen-server:
	@cd app/user && go mod init github.com/kyzyc/biz-demo/app/user && cwgo server --type RPC --idl ../../idl/user.proto --service user --module github.com/kyzyc/biz-demo/app/user --pass "-use github.com/kyzyc/biz-demo/rpc_gen/kitex_gen" -I ../../idl
