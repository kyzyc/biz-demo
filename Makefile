...
gen-server:
	@cd app/user && go mod init github.com/kyzyc/biz-demo/gomall/app/user && cwgo server --type RPC --idl ../../idl/user.proto --service user --module github.com/kyzyc/biz-demo/gomall/app/user --pass "-use github.com/kyzyc/biz-demo/rpc_gen/kitex_gen" -I ../../idl
